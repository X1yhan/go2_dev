...
- **动态追球抓取已通**(2026-09-25):`chase_grasp.py`——监控姿态折叠 → 追球(真值)
  → 停 0.42m → 预测拦截点快移等待 → 球进爪 0.4s 快速闭合 → 抬起;**球全程运动**
  (浮空无重力+速度衰减,±0.35m 摆动,脚本 20Hz 驱动,捕获后才停)
  实测 3 次预测内抓获 z 0.300→0.413;世界里的红球/橙箱/蓝柱/台座已删
